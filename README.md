...
2. In a terminal app, run `npm start`. It will prompt you to select a platform first. The tool then shows you the games that score more than 85 for media review, and more than 8.5 for user review, for that platform. You can modify these scores in the code.
